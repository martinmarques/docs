---
title: '3. Implementing CipherTrust Transparent Encryption (CTE)'
...
**Implementing the CipherTrust Transparent Encryption (CTE) solution requires the following components:**
  ...
  1. Postgres Server installed and operational.
...
**The following screenshots show the User Sets created, Postgres, EnterpriseDB and Barman.**
